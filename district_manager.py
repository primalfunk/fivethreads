...
class DistrictManager:
    ...
    def generate_player_colors(self, num_players):
        non_red_hue_start = 0.1
        non_red_hue_end = 0.9
        hue_step = (non_red_hue_end - non_red_hue_start) / num_players
        player_colors = []
        for i in range(num_players):
            hue = non_red_hue_start + i * hue_step
    ...
    def generate_districts(self):
        ...
        return [District(i, polygon) for i, polygon in enumerate(voronoi_polygons)]
